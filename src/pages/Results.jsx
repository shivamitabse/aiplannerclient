...
export default function Results() {
  ...
  const handleBookConsultation = () => {
    ...
    if (leadFormRef.current) {
      ...
      const emailInput = leadFormRef.current.querySelector(
        'input[type="email"]',
      );
  ...
  const isOptimized =
    ...
    (recommendations.length === 1 && recommendations[0].tool === "General");
    ...
    <div className="max-w-4xl mx-auto px-4 py-12 w-full">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-textMuted max-w-2xl mx-auto">
          We've analyzed your ${currentMonthlySpend}/mo AI spend for your team
          of {inputData.teamSize}.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="card text-center col-span-1 md:col-span-1 border-primary/30 bg-primary/5">
          <div className="text-sm font-medium text-textMuted mb-2">
      ...
      {isOptimized ? (
        <div className="card border-success/30 bg-success/5 mb-12 flex flex-col items-center text-center py-10">
          ...
          <p className="text-textMuted max-w-md">
            Your current AI stack is well-aligned with your team size and use
            case. Keep **AI Spendly** in mind as you scale to ensure your costs
            stay lean!
          </p>
        </div>
      ) : (
              ...
              >
                <div className="bg-surfaceHighlight p-3 rounded-lg flex-shrink-0 mt-1">
                  {rec.tool === "General" ? (
                    ...
                    <AlertTriangle className="text-warning text-yellow-500" />
                  )}
                </div>
      ...
      {totalMonthlySavings > 500 && (
        <div className="card bg-gradient-to-br from-primary/20 to-purple-500/20 border-primary/50 text-center mb-12 p-8">
          ...
          <p className="text-textMuted mb-6 max-w-lg mx-auto">
            Our experts can help you migrate to a more cost-effective API
            architecture without losing productivity.
          </p>
        ...
        {shareUrl ? (
          <div className="text-center py-6">
            ...
            <p className="text-textMuted mb-6">
              {isConsultation
                ? "We've received your request and emailed you the report."
            ...
            <div className="bg-surface p-4 rounded-lg flex flex-col sm:flex-row items-center gap-3 border border-border">
              <span className="truncate text-sm text-textMuted flex-1 text-left w-full sm:w-auto">
                {shareUrl}
              </span>
          ...
          <div>
            <div className="flex items-center justify-center gap-3 mb-6">
              <div
                className={`p-2 rounded-full ${isConsultation ? "bg-primary text-white" : "bg-primary/20 text-primary"}`}
              >
                <Mail size={24} />
              </div>
